  ...
  return (
    <div className="space-y-4" aria-hidden="true">
      ...
      <div className="rounded-2xl border border-amber-200/60 bg-amber-50/30 p-4 shadow-sm">
        <div className="h-4 w-28 animate-pulse rounded bg-amber-200 mb-3" />
        <div className="space-y-2">
          <div className="rounded-xl bg-white px-3 py-3">
            <div className="h-3.5 w-3/4 animate-pulse rounded bg-stone-200 mb-1.5" />
            <div className="h-3 w-1/2 animate-pulse rounded bg-stone-100" />
          </div>
        </div>
      </div>

      {/* Regular notices skeleton */}
      <div className="rounded-2xl border border-stone-200/60 bg-white p-4 shadow-sm">
        ...
        <div className="space-y-2">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="rounded-xl bg-stone-50 px-3 py-3">
