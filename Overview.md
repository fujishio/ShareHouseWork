...
家事・共益費・お知らせを一元管理し、日々の運用負荷を下げることを目的とします。
...
#### 実装済みAPI
- 全エンドポイント（tasks/task-completions/expenses/shopping/notices/rules/settings）
- 永続化先: Firestore（Firebase）
- 認証: Firebase Auth（メール/パスワード）、Bearer トークン検証
