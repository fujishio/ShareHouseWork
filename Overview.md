...
- **Phase 1 セキュリティ修正**（2026-03-04）
  - 未認証エンドポイント（POST /api/users, /api/houses, /api/houses/join）に認証を追加
